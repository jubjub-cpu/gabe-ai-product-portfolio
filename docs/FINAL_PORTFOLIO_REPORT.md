...
See `PORTFOLIO_SCORECARD.md` and the live matrix on `index.html`.
...
[https://jubjub-cpu.github.io/doctrace-desk/](https://jubjub-cpu.github.io/doctrace-desk/)

Standalone DocuTrace release:
